...
public class RegisterConsultationTeacherDocenteClassFixture : IClassFixture<CustomWebApplicationFactory>
{
    private readonly HttpClient _httpClient;

    public RegisterConsultationTeacherDocenteClassFixture(CustomWebApplicationFactory webApplicationFactory)
    {
