...
namespace UseCases.Tests.Consultations.Reports.Excel.ReportByCoordenador;

public class ReportExcelByCoordinatorUseCaseTests
{
    private ReportExcelByCoordinatorUseCase CreateUseCase(
        ...
        )
    {
        ...
        return new ReportExcelByCoordinatorUseCase(readOnlyConsultationRepository, readOnlyUsersRepository, loggedUser);
    }
