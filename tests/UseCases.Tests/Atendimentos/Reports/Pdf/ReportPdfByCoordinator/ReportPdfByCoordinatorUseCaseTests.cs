...
namespace UseCases.Tests.Atendimentos.Reports.Pdf.ReportPdfByCoordinator;

public class ReportPdfByCoordinatorUseCaseTests
{
    private ReportPdfByCoordenadorUseCase CreateUseCase(
        ...
        )
    {
        ...
        return new ReportPdfByCoordenadorUseCase(loggedUser, readOnlyAtendimentoRepository, readOnlyUsersRepository);
    }
