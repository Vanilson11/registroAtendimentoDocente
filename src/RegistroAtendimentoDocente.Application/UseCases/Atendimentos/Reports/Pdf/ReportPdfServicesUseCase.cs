...
public class ReportPdfServicesUseCase : IReportPdfServicesUseCase
{
    ...
    public ReportPdfServicesUseCase(IAtendimentosReadOnlyRepository repository, ILoggedUser loggedUser)
    {
    ...
    public async Task<byte[]> Execute(DateOnly month)
    {
        ...
        var services = await _repository.FilterServicesByMonth(loggedUser, month);
        ...
        foreach(var service in services)
        {
            ...
            if(string.IsNullOrWhiteSpace(service.Encaminhamento) == false)
            {
